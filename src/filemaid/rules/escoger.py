...
_NIF_SPANISH = r"[0-9]{8}[A-Z]|[XYZ][0-9]{7}[A-Z]|[A-HJNP-SUVW][0-9]{7}[0-9A-J]"
_NIF_INTL = r"DE[0-9]{9}|FR[0-9]{11}|[0-9]{2}\.[0-9]{3}\.[0-9]{3}/[0-9]{4}-[0-9]{2}|[0-9]{13}|88[0-9]{6}|898[0-9]{6}"
_NIF_RE = re.compile(rf"^(?:{_NIF_SPANISH}|{_NIF_INTL})$")
_IBAN_RE = re.compile(
    r"^("
    r"ES[0-9]{22}"
    r"|DE[0-9]{20}"
    r"|FR[0-9]{25}"
    r"|GB[0-9]{2}[A-Z]{4}[0-9]{14}"
    r"|BR[0-9]{2}[A-Z0-9]{23,25}"
    r"|JP[0-9]{2}[0-9]{15}"
